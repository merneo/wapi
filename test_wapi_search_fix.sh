...
puts "\n=== Testing search without full config (should work with WHOIS) ==="
# Remove password from config to test WHOIS-only mode
...
send "wapi search google.com 2>&1 | head -20\r"
expect "$ "
